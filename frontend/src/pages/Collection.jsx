      ...
      <div className="min-w-60">
        ...
        <div className={`border border-gray-300 pl-5 py-3 mt-6 ${showFilter ? "" : "hidden"} sm:block`}>
          ...
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            ...
            <p className="flex gap-2">
              <input type="checkbox" className="w-3" value={'GPU'} onChange={toggleCategory}/> GPU
            </p>
            <p className="flex gap-2">
              <input type="checkbox" className="w-3" value={'LCD'} onChange={toggleCategory}/> LCD
            </p>
            <p className="flex gap-2">
              <input type="checkbox" className="w-3" value={'RAM'} onChange={toggleCategory}/> RAM
            </p>
            <p className="flex gap-2">
              <input type="checkbox" className="w-3" value={'SSD'} onChange={toggleCategory}/> SSD
            </p>
            <p className="flex gap-2">
